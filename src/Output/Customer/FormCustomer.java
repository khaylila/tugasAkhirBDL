...
public class FormCustomer extends javax.swing.JFrame {
     ...
     * @param listCustomer
     */
    public FormCustomer(ListCustomer listCustomer, int userId) {
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        if (namaPelanggan.isEmpty() || telpon.isEmpty() || alamat.isEmpty()) {
            ...
            try {
                String query = "INSERT INTO customer(customer_fullname,customer_alamat,customer_telepon,user_id) VALUES(?,?,?,?);";
                ...
                if (preparedStatement.executeUpdate() <= 0) {
                    this.peringatan("Gagal menyimpan customer!");
                } else {
