 ...
 * @author milea
 */
public class FormSparepartsEdit extends javax.swing.JFrame {
    
    DB db;
    ListSpareparts listSupplier;
    int supplierId;
     ...
     * @param supplierId
     */
    public FormSparepartsEdit(ListSpareparts listSupplier, int supplierId) {
        initComponents();
        ...
        if (namaPelanggan.isEmpty() || telpon.isEmpty() || alamat.isEmpty()) {
            ...
            try {
                ...
                if (preparedStatement.executeUpdate() <= 0) {
                    ...
                    this.dispose();
                    ((ListSpareparts) listSupplier).loadTabel();
                }
            } catch (SQLException e) {
                e.printStackTrace();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSparepartsEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSparepartsEdit().setVisible(true);
            }
        });
    }
